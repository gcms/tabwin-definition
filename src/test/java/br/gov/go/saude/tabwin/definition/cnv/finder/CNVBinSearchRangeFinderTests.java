...
public class CNVBinSearchRangeFinderTests {
    @Test
...
//        12  29 dias e +                                        9999
        ...
        CNVCategoryFinder finder = new CNVBinSearchRangeFinder(cnv.getCategories().toArray(CNVCategory[]::new));
...
//        11   Acima de 500.000 beneficiários                    99999999999.99
    ...
    public void testInvalidInput() throws IOException {
        ...
        new CNVBinSearchRangeFinder(cnv.getCategories().toArray(CNVCategory[]::new));
    }
}
